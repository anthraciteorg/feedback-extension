...
/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */new Uint8Array(new Uint32Array([287454020]).buffer)[0];const vt=Array.from({length:256},((t,e)=>e.toString(16).padStart(2,"0")));function yt(t){pt(t);let e="";for(let s=0;s<t.length;s++)e+=vt[t[s]];return e}function wt(t){return"string"==typeof t&&(t=function(t){if("string"!=typeof t)throw new Error("utf8ToBytes expected string, got "+typeof t);return new Uint8Array((new TextEncoder).encode(t))}(t)),pt(t),t}class _t{clone(){return this._cloneInto()}}function kt(t){const e=e=>t().update(wt(e)).digest(),s=t();return e.outputLen=s.outputLen,e.blockLen=s.blockLen,e.create=()=>t(),e}const $t=(t,e,s)=>t&e^~t&s,St=(t,e,s)=>t&e^t&s^e&s;class xt extends _t{constructor(t,e,s,i){super(),this.blockLen=t,this.outputLen=e,this.padOffset=s,this.isLE=i,this.finished=!1,this.length=0,this.pos=0,this.destroyed=!1,this.buffer=new Uint8Array(t),this.view=gt(this.buffer)}update(t){ft(this);const{view:e,buffer:s,blockLen:i}=this,n=(t=wt(t)).length;for(let r=0;r<n;){const o=Math.min(i-this.pos,n-r);if(o!==i)s.set(t.subarray(r,r+o),this.pos),this.pos+=o,r+=o,this.pos===i&&(this.process(e,0),this.pos=0);else{const e=gt(t);for(;i<=n-r;r+=i)this.process(e,r)}}return this.length+=t.length,this.roundClean(),this}digestInto(t){ft(this),function(t,e){pt(t);const s=e.outputLen;if(t.length<s)throw new Error(`digestInto() expects output buffer of length at least ${s}`)}(t,this),this.finished=!0;const{buffer:e,view:s,blockLen:i,isLE:n}=this;let{pos:r}=this;e[r++]=128,this.buffer.subarray(r).fill(0),this.padOffset>i-r&&(this.process(s,0),r=0);for(let t=r;t<i;t++)e[t]=0;!function(t,e,s,i){if("function"==typeof t.setBigUint64)return t.setBigUint64(e,s,i);const n=BigInt(32),r=BigInt(4294967295),o=Number(s>>n&r),h=Number(s&r),a=i?4:0,c=i?0:4;t.setUint32(e+a,o,i),t.setUint32(e+c,h,i)}(s,i-8,BigInt(8*this.length),n),this.process(s,0);const o=gt(t),h=this.outputLen;if(h%4)throw new Error("_sha2: outputLen should be aligned to 32bit");const a=h/4,c=this.get();if(a>c.length)throw new Error("_sha2: outputLen bigger than state");for(let t=0;t<a;t++)o.setUint32(4*t,c[t],n)}digest(){const{buffer:t,outputLen:e}=this;this.digestInto(t);const s=t.slice(0,e);return this.destroy(),s}_cloneInto(t){t||(t=new this.constructor),t.set(...this.get());const{blockLen:e,buffer:s,length:i,finished:n,destroyed:r,pos:o}=this;return t.length=i,t.pos=o,t.finished=n,t.destroyed=r,i%e&&t.buffer.set(s),t}}const Ct=new Uint32Array([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]),Et=new Uint32Array([1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225]),Tt=new Uint32Array(64);class At extends xt{constructor(){super(64,32,8,!1),this.A=0|Et[0],this.B=0|Et[1],this.C=0|Et[2],this.D=0|Et[3],this.E=0|Et[4],this.F=0|Et[5],this.G=0|Et[6],this.H=0|Et[7]}get(){const{A:t,B:e,C:s,D:i,E:n,F:r,G:o,H:h}=this;return[t,e,s,i,n,r,o,h]}set(t,e,s,i,n,r,o,h){this.A=0|t,this.B=0|e,this.C=0|s,this.D=0|i,this.E=0|n,this.F=0|r,this.G=0|o,this.H=0|h}process(t,e){for(let s=0;s<16;s++,e+=4)Tt[s]=t.getUint32(e,!1);for(let t=16;t<64;t++){const e=Tt[t-15],s=Tt[t-2],i=mt(e,7)^mt(e,18)^e>>>3,n=mt(s,17)^mt(s,19)^s>>>10;Tt[t]=n+Tt[t-7]+i+Tt[t-16]|0}let{A:s,B:i,C:n,D:r,E:o,F:h,G:a,H:c}=this;for(let t=0;t<64;t++){const e=c+(mt(o,6)^mt(o,11)^mt(o,25))+$t(o,h,a)+Ct[t]+Tt[t]|0,l=(mt(s,2)^mt(s,13)^mt(s,22))+St(s,i,n)|0;c=a,a=h,h=o,o=r+e|0,r=n,n=i,i=s,s=e+l|0}s=s+this.A|0,i=i+this.B|0,n=n+this.C|0,r=r+this.D|0,o=o+this.E|0,h=h+this.F|0,a=a+this.G|0,c=c+this.H|0,this.set(s,i,n,r,o,h,a,c)}roundClean(){Tt.fill(0)}destroy(){this.set(0,0,0,0,0,0,0,0),this.buffer.fill(0)}}const Ut=kt((()=>new At)),It={version:.6,endpoint:"https://feedback.anthra.site",feedback:{}};const Ot=new class e{static key="anthracite-feedback";container;constructor(){if(this.container=SillyTavern.getContext().extensionSettings[e.key],this.container){if(this.container.version===It.version)return;this.container=function(t){t.version<=.5&&("https://rlhf.frammie.ee"===t.endpoint&&(t.endpoint="https://feedback.anthra.site",t.feedback={}),t.version=.6);return t}(this.container)}else this.container={...It,userId:this._generateUserId()};this.save()}save(){SillyTavern.getContext().extensionSettings[e.key]=this.container,t.saveSettings()}clearCache(){this.container.feedback={},this.save()}_generateUserId(){return yt(Ut(function(t=32){if(bt&&"function"==typeof bt.getRandomValues)return bt.getRandomValues(new Uint8Array(t));throw new Error("crypto.getRandomValues must be defined")}(256)))}},Pt="Anon";var jt;function Mt(e){return Array.isArray(e)?e.map((t=>(t.content=Mt(t.content),t))):e.replaceAll(new RegExp(t.name1,"gi"),Pt)}!function(t){t[t.Text=0]="Text",t[t.Chat=1]="Chat"}(jt||(jt={}));class Rt{messageId;rating;explanation;tags;get partiallyFilled(){return!(!this.explanation&&!this.tags?.length)}constructor(t,e){this.messageId=Rt._generateUniqueId(t),this.rating=e}load(){const t=Ot.container.feedback[this.messageId];t&&(this.messageId=t.messageId,this.rating=t.rating,this.explanation=t.explanation,this.tags=t.tags)}save(){Ot.container.feedback[this.messageId]=this,Ot.save()}delete(){delete Ot.container.feedback[this.messageId],Ot.save()}static _generateUniqueId(e){const s=t.chat[e],i=s.swipe_info[s.swipe_id],n=i.gen_started instanceof Date?i.gen_started.toISOString():i.gen_started;return yt(Ut([t.getCurrentChatId(),e,s.swipe_id,n].join("|")))}}
/**
 * @license
